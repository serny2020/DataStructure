...
public class TimeSeriesTest {
    ...
    public void divTest() {
        ...
        dogPopulation.put(1995, 500.0); //should ignore this value
    ...
    @Test
    public void copyTsTest() {
        TimeSeries catPopulation = new TimeSeries();
        catPopulation.put(1991, 0.0);
        catPopulation.put(1992, 100.0);
        catPopulation.put(1994, 400.0);
        TimeSeries catCopy = new TimeSeries(catPopulation, 1991, 1992);
        List<Integer> expectedYears = new ArrayList<>
                (Arrays.asList(1991, 1992));
        assertThat(catCopy.years()).isEqualTo(expectedYears);
    }
